...
+ (void)addNotificationWithContent:(UNNotificationContent *)content
                  ...
                  completionHanler:(void(^)(NSError *error))handler API_AVAILABLE(ios(10.0)) API_AVAILABLE(ios(10.0));
...
+ (UNMutableNotificationContent *)contentWithTitle:(NSString *)title
                                   subTitle:(NSString *)subTitle
                                              body:(NSString API_AVAILABLE(ios(10.0)) *)body API_AVAILABLE(ios(10.0));
/*
 * badge  标记
 */
+ (UNMutableNotificationContent *)contentWithTitle:(NSString *)title
...
+ (UNMutableNotificationContent *)contentWithTitle:(NSString *)title
                                   subTitle:(NSString *)subTitle
                                       body:(NSString *)body
                                             sound:(UNNotificationSound  API_AVAILABLE(ios(10.0))*)sound API_AVAILABLE(ios(10.0));
