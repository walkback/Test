...
@interface Illumination_ViewController () <UITableViewDelegate,UITableViewDataSource>
{
    Data_View *dataView;
...
@implementation Illumination_ViewController
